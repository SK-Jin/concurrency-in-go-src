...
func main() {
	...
	// 	//doWork2, intStream2 := doWorkFn(done2, 1, 2, -1, 3, 4, 5)     // <1>
	// 	doWork2, intStream2 := doWorkFn(done2, 1, 2, 3, 4, 5)         // <1>
	// 	doWorkWithSteward2 := newSteward(1*time.Millisecond, doWork2) // <2>
	// 	doWorkWithSteward2(done2, 1*time.Hour)                        // <3>

	// 	for intVal2 := range take(done2, intStream2, 6) { // <4>
